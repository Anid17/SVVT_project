...
public class Block {
    ...
    public void testLoginToX() {
        ...
        SearchButton.click();
        SearchButton.sendKeys("Jake Paul "+ Keys.ENTER);

        WebElement PaulButton = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"react-root\"]/div/div/div[2]/main/div/div/div/div/div/div[3]/section/div/div/div[3]/div/div/button/div/div[2]/div/div[1]/div/div[1]/a/div/div[1]/span/span[1]")));
        PaulButton.click();

        /*works fine*/
        WebElement MoreButton = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@id=\"react-root\"]/div/div/div[2]/main/div/div/div/div/div/div[3]/div/div/div/div/div[1]/div[2]/button[1]/div")));
        MoreButton.click();

        WebElement BlockButton = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"layers\"]/div[2]/div/div/div/div[2]/div/div[3]/div/div/div/div[4]/div[2]/div/span")));
        BlockButton.click();

        WebElement BlockButton2 = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"layers\"]/div[2]/div/div/div/div/div/div[2]/div[2]/div[2]/button[1]/div/span/span")));
        BlockButton2.click();
