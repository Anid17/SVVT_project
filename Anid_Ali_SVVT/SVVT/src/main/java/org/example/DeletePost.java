...
public class DeletePost {
    ...
    public void testLoginToX() {
        System.out.println("Deleting the post on X ...");
        ...
        WebElement ProfileButton = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"react-root\"]/div/div/div[2]/main/div/div/div/div/div/div[3]/div/div[2]/div[1]/div/div/div/div[1]/div/div[2]/div/div[2]/div/a/div[4]")));
        ProfileButton.click();

        WebElement MoreButton1 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@id=\"react-root\"]/div/div/div[2]/main/div/div/div/div/div/div[3]/div/div/section/div/div/div[4]/div[1]/div/article/div/div/div[2]/div[2]/div[1]/div/div[2]/div/div/div/div/button/div/div")));
        MoreButton1.click();

        WebElement DeleteButton = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@id=\"layers\"]/div[2]/div/div/div/div[2]/div/div[3]/div/div/div/div[1]")));
        DeleteButton.click();

        WebElement DeleteButton1 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@id=\"layers\"]/div[2]/div/div/div/div/div/div[2]/div[2]/div[2]/button[1]/div")));
        DeleteButton1.click();
