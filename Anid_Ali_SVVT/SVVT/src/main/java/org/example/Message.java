...
public class Message {
    ...
    public void testLoginToX() {
      ...
      /*  WebElement ExploreButton = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"react-root\"]/div/div/div[2]/header/div/div/div/div[1]/div[2]/nav/a[2]/div")));
        ExploreButton.click();
*/
        ...
        SearchButton.click();
        SearchButton.sendKeys("Aan1d7 "+ Keys.ENTER);

        WebElement An1d7Button = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"react-root\"]/div/div/div[2]/main/div/div/div/div/div/div[3]/section/div/div/div[3]/div/div/button/div/div[2]/div/div[1]/div/div[1]/a/div/div[1]/span/span[1]")));
        An1d7Button.click();

        WebElement MessageButton = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"react-root\"]/div/div/div[2]/main/div/div/div/div/div/div[3]/div/div/div/div[2]/div[1]/div[2]/button[3]/div")));
        MessageButton.click();

        WebElement MessageButton2 = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"react-root\"]/div/div/div[2]/main/div/div/div/section[2]/div/div/div[2]/div/div/aside/div[2]/div[2]/div/div/div/div/div/div/div[1]/div/div/div/div/div/div[2]/div")));
        MessageButton2.click();
        MessageButton2.sendKeys("Aan1d7 "+ Keys.ENTER);
